            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12 mb-2">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="username" value="<?= isset($old['username']) ? $old['username'] : $user->username; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 mb-2">
                  <div class="form-group">
                    <label>Name</label>
                    <input class="form-control" type="text" name="name" value="<?= isset($old['name']) ? $old['name'] : $user->name; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 mb-2">
                  <div class="form-group">
                    <label>Email</label>
                    <input class="form-control" type="text" name="email" value="<?= isset($old['email']) ? $old['email'] : $user->email; ?>">
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12 mb-2">
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" name="status" id="post-status-enabled" value="1" <?php if (isset($old['status']) && $old['status'] === 1) : ?> checked <?php endif; ?> <?php if ($user->status === 1) : ?> checked <?php endif; ?>>
                      <label for="post-status-enabled" class="custom-control-label" style="font-weight: 400;">Enabled</label>
                    </div>
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" name="status" id="post-status-disabled" value="0" <?php if (isset($old['status']) && $old['status'] === 0) : ?> checked <?php endif; ?> <?php if ($user->status === 0) : ?> checked <?php endif; ?>>
